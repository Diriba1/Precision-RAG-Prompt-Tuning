...
openai.api_key = "openai_api_key" # enter your OpenAI API key here
...
system_gen_system_prompt = """Your job is to generate system prompts for GPT-3, given a description of the use-case and some test cases.
...
PORTKEY_API = "653c936f063ff9c5422dab5ae1f7e7366deeec2f" # used if use_portkey is True. Get api key here: https://app.portkey.ai/ (click on profile photo on top left)
